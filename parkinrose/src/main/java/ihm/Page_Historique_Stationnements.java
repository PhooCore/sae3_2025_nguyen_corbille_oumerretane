...
import controleur.ControleurHistoriqueStationnements;
...
public class Page_Historique_Stationnements extends JFrame {
    ...
    private JButton btnRetour; // Déclarer comme variable d'instance
    private JTable table; // Déclarer comme variable d'instance
    ...
    public Page_Historique_Stationnements(String email) {
        ...
        // Créer et lier le contrôleur APRÈS avoir initialisé l'interface
        new ControleurHistoriqueStationnements(this);
    }
    ...
    private void initialisePage() {
        ...
        // Bouton de retour
        btnRetour = new JButton("← Retour"); // Initialiser ici
        ...
        table = new JTable(donnees, colonnes); // Initialiser ici
